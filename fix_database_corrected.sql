-- =====================================================
-- SCRIPT CORREGIDO PARA ARREGLAR ERRORES DE BASE DE DATOS
...
-- 4. Crear tabla roles con estructura correcta
...
-- 6. Insertar roles básicos si no existen (sin display_name)
INSERT INTO public.roles (name, description, permissions) VALUES
('user', 'Usuario regular de la plataforma', '["read_profile", "update_profile", "purchase_music", "create_events"]'),
('artist', 'Artista musical', '["read_profile", "update_profile", "upload_music", "create_events", "manage_events"]'),
...
-- 15. Función mejorada para crear perfil automáticamente (SIN user_settings)
