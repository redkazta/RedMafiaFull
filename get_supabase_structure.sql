-- =====================================================
-- CONSULTA ESPECÍFICA PARA SUPABASE
...
-- 10. Verificar si RLS está habilitado en cada tabla
SELECT 
    schemaname,
    tablename,
...
-- 12. Información adicional sobre la base de datos
SELECT 
...
-- 13. Obtener información de tipos de datos (versión compatible con Supabase)
SELECT 
    typname as type_name,
    typtype as type_category,
    typcategory as type_category_code
FROM pg_type 
WHERE typnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'public')
ORDER BY typname;

-- 14. Verificar tablas específicas que podrían existir
SELECT 
    table_name,
    table_type
